  ...
  return (
    ...
    <div className={classes.Eduludo}>
      <div className={classes.HeaderFlex}>
        <div>
          <Link to='/'>
            <button onClick={()=>{localStorage.clear()}}className={classes.goBackButton} component={Link} to={`/`}>Go back</button>
          </Link>
        </div>
        <div className={classes.Coins}>
          <p className={classes.CoinsCount}>{localStorage.scores ? localStorage.scores : 0}</p>
